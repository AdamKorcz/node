{
  ...
  'targets': [
    ...
    { # fuzz_v8_deserialize
      'target_name': 'fuzz_v8_deserialize',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_buffer_compare
      'target_name': 'fuzz_buffer_compare',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_buffer_equals
      'target_name': 'fuzz_buffer_equals',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_buffer_includes
      'target_name': 'fuzz_buffer_includes',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_zlibBrotliDecompress
      'target_name': 'fuzz_zlibBrotliDecompress',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_zlibBrotliDecompress.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    { # fuzz_zlib_createBrotliDecompress
      'target_name': 'fuzz_zlib_createBrotliDecompress',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_zlib_gzip_createUnzip
      'target_name': 'fuzz_zlib_gzip_createUnzip',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_querystring_parse
      'target_name': 'fuzz_querystring_parse',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_string_decoder
      'target_name': 'fuzz_string_decoder',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_path_normalize
      'target_name': 'fuzz_path_normalize',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_path_basename
      'target_name': 'fuzz_path_basename',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_path_isAbsolute
      'target_name': 'fuzz_path_isAbsolute',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_path_relative
      'target_name': 'fuzz_path_relative',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_path_toNamespacedPath
      'target_name': 'fuzz_path_toNamespacedPath',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_fs_write_open_read
      'target_name': 'fuzz_fs_write_open_read',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_fs_write_read_append
      'target_name': 'fuzz_fs_write_read_append',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_tls_socket_request
      'target_name': 'fuzz_tls_socket_request',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_diffieHellmanDER
      'target_name': 'fuzz_diffieHellmanDER',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_diffieHellmanPEM
      'target_name': 'fuzz_diffieHellmanPEM',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_diffieHellmanJWK
      'target_name': 'fuzz_diffieHellmanJWK',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_createPrivateKeyDER
      'target_name': 'fuzz_createPrivateKeyDER',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_createPrivateKeyPEM
      'target_name': 'fuzz_createPrivateKeyPEM',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_createPrivateKeyJWK
      'target_name': 'fuzz_createPrivateKeyJWK',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
    ...
    { # fuzz_ParseSrvReply
      'target_name': 'fuzz_ParseGeneralReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseGeneralReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    }, # fuzz_ParseGeneralReply
    { # fuzz_ParseMxReply
      'target_name': 'fuzz_ParseMxReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseMxReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    { # fuzz_ParseCaaReply
      'target_name': 'fuzz_ParseCaaReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseCaaReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    { # fuzz_ParseTxtReply
      'target_name': 'fuzz_ParseTxtReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseTxtReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    { # fuzz_ParseSrvReply
      'target_name': 'fuzz_ParseSrvReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseSrvReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    { # fuzz_ParseNaptrReply
      'target_name': 'fuzz_ParseNaptrReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseNaptrReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
    ...
    { # fuzz_ParseSoaReply
      'target_name': 'fuzz_ParseSoaReply',
      'type': 'executable',
      'dependencies': [
        '<(node_lib_target_name)',
        'deps/histogram/histogram.gyp:histogram',
      ...
      'sources': [
        'src/node_snapshot_stub.cc',
        'test/fuzzers/fuzz_ParseSoaReply.cc',
      ],
      'conditions': [
        ['OS=="linux"', {
          'ldflags': [ '-fsanitize=fuzzer' ]
